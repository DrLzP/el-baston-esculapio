...
export default function PerfusionesPage() {
  const tabs = [
    { label: "Noradrenalina", path: "/perfusiones/noradrenalina" },
    { label: "Insulina", path: "/perfusiones/insulina" }
  ];
  ...
  return (
    <main className="min-h-screen bg-gray-100 py-10 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-8">Perfusiones</h1>
